...
- **Bento Grid** — 선택한 2D 푸티지/프리컴프 레이어를 모듈 그리드(1×1~4×4 타일)에 패킹. Tools 타일을 누르면 동봉한 `BentoGrid.jsx` 팔레트 창(Unit/Gap/Width·Fit·Variety·Packing Style·Crop/Center/Mix, Repack·Randomize·Clear Masks)이 열립니다.
